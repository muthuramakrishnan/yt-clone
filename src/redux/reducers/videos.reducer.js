import { HOME_VIDEOS_FAIL, HOME_VIDEOS_REQUEST, HOME_VIDEOS_SUCCESS, SELECTED_VIDEO_REQUEST, SELECTED_VIDEO_FAIL, SELECTED_VIDEO_SUCCESS, RELATED_VIDEO_REQUEST, RELATED_VIDEO_SUCCESS, RELATED_VIDEO_FAIL, SEARCH_VIDEO_REQUEST, SEARCH_VIDEO_SUCCESS, SEARCH_VIDEO_FAIL, SUBSCRIPTIONS_CHANNEL_REQUEST, SUBSCRIPTIONS_CHANNEL_SUCCESS, SUBSCRIPTIONS_CHANNEL_FAIL, CHANNEL_VIDEOS_REQUEST, CHANNEL_VIDEOS_SUCCESS, CHANNEL_VIDEOS_FAIL } from "../actionType";
...
export const searchVideoReducer = (state = { loading: true, videos: []}, action) => {
    const { payload, type } = action;
...
export const channelVideosReducer = (state = { loading: true, videos: []}, action) => {
    ...
    switch (type){
        case CHANNEL_VIDEOS_REQUEST: return{
            ...state,
            loading: true
        }

        case CHANNEL_VIDEOS_SUCCESS: return{
            ...state,
            videos: payload,
            loading: false
        }

        case CHANNEL_VIDEOS_FAIL: return{
            ...state,
            loading: false,
            error: payload
        }
